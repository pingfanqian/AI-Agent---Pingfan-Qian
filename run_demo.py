...
def generate_trade_note_openai(
    ...
    if not api_key or OpenAI is None:
        ...
        note = (
            ...
            "Run with `OPENAI_API_KEY=... python run_demo.py --trade_note` to generate a full note.\n\n"
            "## Backtest snapshot\n"
...
def main() -> int:
    ...
    if df is None or df.empty:
        raise RuntimeError("yfinance returned empty data. Check ticker, period/interval, or try later.")
